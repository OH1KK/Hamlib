 ...
 * FT-950, FT-450, FT-1200, FTDX-3000.  Much testing remains.  -N0NB
 *
 *
 ...
 * All of the CAT commands used in the newcat interface are available on the FT-950, FT-2000, FT-5000, 
 * FTDX-3000 and FT-9000.
...
/*   Command    FT-450  FT-950  FT-891  FT-991  FT-2000 FT-9000 FT-5000 FT-1200 FTDX-3000 */
    ...
    {"DT",      FALSE,  FALSE,  TRUE,   TRUE,   FALSE,  FALSE,  FALSE,  TRUE,	TRUE    },
    ...
    {"ID",      TRUE,   TRUE,   TRUE,   TRUE,   TRUE,   TRUE,   TRUE,   TRUE,	FALSE   },
    ...
    switch (rig_id) {
        ...
        case NC_RIGID_FT1200:
            ...
            *mwpower = power * 100000;
            ...
            break;
        case NC_RIGID_FTDX3000:
            /* 100 Watts */
            *mwpower = power * 100000;
            rig_debug(RIG_DEBUG_TRACE, "case FTDX3000 - rig_id = %d, *mwpower = %d\n", rig_id, *mwpower);
            break;
        default:
            /* 100 Watts */
            *mwpower = power * 100000;
...
int newcat_mW2power(RIG * rig, float *power, unsigned int mwpower, freq_t freq, rmode_t mode)
{
    ...
    switch (rig_id) {
        ...
        case NC_RIGID_FTDX3000:
            /* 100 Watts */
            *power = mwpower / 100000.0;
            rig_debug(RIG_DEBUG_TRACE, "case FTDX3000 - rig_id = %d, *power = %f\n", rig_id, *power);
            break;
        default:
            /* 100 Watts */
            *power = mwpower / 100000.0;
...
ncboolean newcat_valid_command(RIG *rig, char const * const command) {
    ...
    if (!is_ft450 && !is_ft950 && !is_ft891 && !is_ft991 && !is_ft2000 && !is_ft5000 && !is_ftdx3000 && !is_ft9000 & !is_ft1200 ) {
    ...
    while (search_low <= search_high) {
        ...
        if (search_test > 0)
            ...
            if (is_ft450 && valid_commands[search_index].ft450)
                ...
                return TRUE;
            else if (is_ftdx3000 && valid_commands[search_index].ftdx3000)
                return TRUE;
            else {
