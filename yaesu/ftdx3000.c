 ...
 *
 * ftdx3000.c - (C) Kari Karvonen (oh1kk at toimii.fi)
 *
 * This shared library provides an API for communicating
 * via serial interface to an FT DX 3000 using the "CAT" interface
 *
 *
...
const struct rig_caps ftdx3000_caps = {
    ...
    .write_delay =        FTDX3000_WRITE_DELAY,
    .post_write_delay =   FTDX3000_POST_WRITE_DELAY,
    .timeout =            2000,
    .retry =              3,
    .has_get_func =       FTDX3000_FUNCS,
    .has_set_func =       FTDX3000_FUNCS,
    .has_get_level =      FTDX3000_LEVELS,
    .has_set_level =      RIG_LEVEL_SET(FTDX3000_LEVELS),
    ...
    .tx_range_list1 =     {
        FRQ_RNG_HF(1, FTDX3000_OTHER_TX_MODES, W(5), W(200), FTDX3000_VFO_ALL, FTDX3000_TX_ANTS),
        FRQ_RNG_HF(1, FTDX3000_AM_TX_MODES, W(2), W(75), FTDX3000_VFO_ALL, FTDX3000_TX_ANTS),	/* AM class */
        FRQ_RNG_6m(1, FTDX3000_OTHER_TX_MODES, W(5), W(200), FTDX3000_VFO_ALL, FTDX3000_TX_ANTS),
        FRQ_RNG_6m(1, FTDX3000_AM_TX_MODES, W(2), W(75), FTDX3000_VFO_ALL, FTDX3000_TX_ANTS),	/* AM class */
    ...
    .tx_range_list2 =     {
        FRQ_RNG_HF(2, FTDX3000_OTHER_TX_MODES, W(5), W(200), FTDX3000_VFO_ALL, FTDX3000_TX_ANTS),
        FRQ_RNG_HF(2, FTDX3000_AM_TX_MODES, W(2), W(75), FTDX3000_VFO_ALL, FTDX3000_TX_ANTS),	/* AM class */
        FRQ_RNG_6m(2, FTDX3000_OTHER_TX_MODES, W(5), W(200), FTDX3000_VFO_ALL, FTDX3000_TX_ANTS),
        FRQ_RNG_6m(2, FTDX3000_AM_TX_MODES, W(2), W(75), FTDX3000_VFO_ALL, FTDX3000_TX_ANTS),	/* AM class */

        RIG_FRNG_END,
    },

    .tuning_steps =       {
        {FTDX3000_SSB_CW_RX_MODES, Hz(10)},    /* Normal */
        {FTDX3000_SSB_CW_RX_MODES, Hz(100)},   /* Fast */

        {FTDX3000_AM_RX_MODES,     Hz(100)},   /* Normal */
        {FTDX3000_AM_RX_MODES,     kHz(1)},    /* Fast */

        {FTDX3000_FM_RX_MODES,     Hz(100)},   /* Normal */
        {FTDX3000_FM_RX_MODES,     kHz(1)},    /* Fast */
    ...
    .filters =            {
        {FTDX3000_CW_RTTY_PKT_RX_MODES,  Hz(1800)},   /* Normal CW, RTTY, PKT/USER */
        {FTDX3000_CW_RTTY_PKT_RX_MODES,  Hz(500)},    /* Narrow CW, RTTY, PKT/USER */
        {FTDX3000_CW_RTTY_PKT_RX_MODES,  Hz(2400)},   /* Wide   CW, RTTY, PKT/USER */
        ...
        {FTDX3000_FM_RX_MODES,           Hz(15000)},  /* Normal FM  */
        {FTDX3000_FM_RX_MODES,           Hz(8000)},   /* Narrow FM  */
