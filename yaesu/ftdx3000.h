 ...
 *
 * ftdx3000.h - (C) Kari Karvonen (oh1kk at toimii.fi) 
 *
...
#define FTDX3000_VFO_ALL (RIG_VFO_A|RIG_VFO_B)

/* Receiver caps */

#define FTDX3000_ALL_RX_MODES (RIG_MODE_AM|RIG_MODE_CW|RIG_MODE_CWR|RIG_MODE_SSB|\
				RIG_MODE_RTTY|RIG_MODE_RTTYR|\
		                RIG_MODE_PKTLSB|RIG_MODE_PKTUSB|RIG_MODE_PKTFM)

#define FTDX3000_SSB_CW_RX_MODES (RIG_MODE_CW|RIG_MODE_CWR|RIG_MODE_SSB|\
		RIG_MODE_RTTY|RIG_MODE_RTTYR|RIG_MODE_PKTLSB|RIG_MODE_PKTUSB)
#define FTDX3000_AM_RX_MODES (RIG_MODE_AM)
#define FTDX3000_FM_RX_MODES (RIG_MODE_FM|RIG_MODE_PKTFM)
#define FTDX3000_CW_RTTY_PKT_RX_MODES (RIG_MODE_RTTY|RIG_MODE_RTTYR|\
...
#define FTDX3000_OTHER_TX_MODES (RIG_MODE_CW|RIG_MODE_SSB|RIG_MODE_RTTY| \
		                RIG_MODE_PKTLSB|RIG_MODE_PKTUSB|RIG_MODE_PKTFM) /* 100 W class */
#define FTDX3000_AM_TX_MODES (RIG_MODE_AM)    /* set 25W max */

/* TBC */
#define FTDX3000_LEVELS (RIG_LEVEL_ATT|RIG_LEVEL_PREAMP|\
...
#define FTDX3000_VFO_DATA_LENGTH           18      /* 0x10 P1 = 03 return size -- A & B returned */
#define FTDX3000_MEM_CHNL_DATA_LENGTH      19      /* 0x10 P1 = 04, P4 = 0x01-0x20 return size */
#define FTDX3000_STATUS_FLAGS_LENGTH       5       /* 0xf7, 0xfa return size */
#define FTDX3000_ALL_DATA_LENGTH           649     /* 0x10 P1 = 00 return size */
...
#define FTDX3000_POST_WRITE_DELAY               5
